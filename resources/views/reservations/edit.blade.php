        ...
        <form class="form-width" method="POST" action="{{route('reservations.update', $reservation)}}">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input value="{{$reservation->date_of_rent}}" class="form-control" type="date" name="date_of_rent" value="today_parsed" id="example-date-input">
            </div>
            <div class="form-group col-md-6">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
                <label for="price">Price:</label>
                  ...
                  <input value="{{$reservation->price}}" type="text" name="price" class="form-control" aria-label="Amount (to the nearest dollar)" value="0">
                </div>
            </div>
            <div class="form-group col-md-6">
              <p>Delivery:</p>
              ...
              <div class="form-check form-check-inline">
                <input value="{{$reservation->deliverer}}" class="form-check-input" type="radio" name="deliverer" id="inlineRadio1" value="Milos">
                <label class="form-check-label" for="inlineRadio1">Milos</label>
              </div>
              <div class="form-check form-check-inline">
                <input value="{{$reservation->deliverer}}" class="form-check-input" type="radio" name="deliverer" id="inlineRadio2" value="Steva">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-3">
              ...
              <input value="{{$reservation->joystick}}" class="form-control" type="number" name="joystick">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="inputComment">Comment</label>
              <input value="{{$reservation->comment}}" type="text" class="form-control" name="comment">
            </div>
          </div>  
