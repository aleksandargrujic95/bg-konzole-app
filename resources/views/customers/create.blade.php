          ...
          <form class="form-width" method="POST" action="/customers">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" placeholder="Customer Address 2" name="address2">
              </div>
              <div class="form-group col-md-4">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" placeholder="Second Phone Number" name="phone_number2">
              </div>
            </div>
